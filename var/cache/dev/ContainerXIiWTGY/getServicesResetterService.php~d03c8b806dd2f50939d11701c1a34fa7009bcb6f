...
}), ['form.choice_list_factory.cached' => 'reset', 'profiler' => 'reset', 'debug.validator' => 'reset', 'debug.stopwatch' => 'reset', 'form.type.entity' => 'reset', 'security.token_storage' => 'setToken', 'fos_rest.view_handler.default' => 'reset']);
